...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreeterForm = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement("input", { type: "text", ref: "msg", placeholder: "Enter your Message" }),
	            React.createElement("br", null),
	            React.createElement(
	                "button",
	                null,
	...
	var Greeter = React.createClass({
	    ...
	    handleData: function handleData(updateObj) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: "Umer", msg: "Welcome" }), document.getElementById("app"));
